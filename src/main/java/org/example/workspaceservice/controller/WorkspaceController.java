...
public class WorkspaceController {
    ...
    public ResponseEntity<?> createWorkspace(@RequestBody @Valid WorkspaceRequest workspaceRequest) {
    ...
    public ResponseEntity<?> getWorkspace(@PathVariable @Valid UUID workspaceId) {
        ApiResponse<?> response = ApiResponse.builder()
    ...
    public ResponseEntity<?> updateWorkspace(@PathVariable @Valid UUID workspaceId,@RequestBody @Valid WorkspaceRequest workspaceRequest) {
        ApiResponse<?> response = ApiResponse.builder()
    ...
    public ResponseEntity<?> deleteWorkspace(@PathVariable @Valid UUID workspaceId) {
        ApiResponse<?> response = ApiResponse.builder()
